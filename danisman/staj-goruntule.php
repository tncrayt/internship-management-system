                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="example1"
                                            ...
                                            $query=$db->prepare("SELECT staj_kayit.id as kayit_id,ad,soyad,ogrenci_no,tel,email,kullanicilar.id as k_id,danisman_onay  FROM staj_kayit
...
WHERE ogrenci_detay.danisman_id_fk=:danisman_id");
                                            $query->execute([
                ...
                }, "colvis",
                    {
                        ...
                        buttons: [
                            ...
                            },
                            {
                                text: 'Onaylanan',
                                action: function ( e, dt, node, config ) {
                                    table.columns(4).search( "Onaylandı" ).draw();
                                }
                            },
                            {
                                text: 'İşlem Bekleyen',
                                action: function ( e, dt, node, config ) {
                                    table.columns(4).search( "Bekleniyor" ).draw();
                                }
                            }
                        ],
                        dropup: true,
