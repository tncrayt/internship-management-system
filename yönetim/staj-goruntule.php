                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="example1"
                                            ...
                                            $query=$db->query("SELECT staj_kayit.id as kayit_id,ad,soyad,ogrenci_no,tel,email,kullanicilar.id as k_id,mudur_onay,bolum_ad  FROM staj_kayit
...
INNER JOIN bolumler ON ogrenci_detay.bolum_id_fk=bolumler.id
WHERE staj_kayit.danisman_onay=1");
                ...
                }, "colvis",
                    {
                        ...
                        buttons: [
                            ...
                            },
                            {
                                text: 'Onaylanan',
                                action: function ( e, dt, node, config ) {
                                    table.columns(5).search( "Onaylandı" ).draw();
                                }
                            },
                            {
                                text: 'İşlem Bekleyen',
